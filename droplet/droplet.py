...
def foo():
  ...
  resp = {"allday": {"url": "https://allanwblog-heroku-18.herokuapp.com/foo/allday.mp3", "type": "mp3", "canSkip": "true", "id": "ded84ffd4b8b47c9755652c2143c15cg", "name": "AllDay"}}
...
def french(filepath):
  ...
  for file in files.matches:
    if file.metadata.name == 'allday.mp3':
